...
<head>
    ...
    <title>L?ch s? ??n h?ng - E-commerce</title>
...
<body class="bg-[#F8F9FA] leading-relaxed tracking-wide">
    ...
    <nav class="bg-white border-b border-gray-200">
        <div class="container mx-auto max-w-[1200px] px-4 py-3">
            <ol class="flex items-center space-x-2 text-sm">
                ...
                <li class="text-[#6C757D]">/</li>
                <li class="text-[#212529] font-medium">??n h?ng c?a t?i</li>
            </ol>
        </div>
    </nav>
    ...
    <div class="container mx-auto max-w-[1200px] px-4 py-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between space-y-4 md:space-y-0">
                <div>
                    <h1 class="text-3xl font-bold text-[#212529] mb-2">??n h?ng c?a t?i</h1>
                    <p class="text-[#6C757D]">Qu?n l? v? theo d?i t?t c? ??n h?ng c?a b?n</p>
                </div>
                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <input type="text" id="orderSearch" placeholder="T?m ki?m ??n h?ng..." class="w-64 h-10 px-4 pr-10 border border-[#CED4DA] rounded-md focus:outline-none focus:ring-2 focus:ring-[#0D6EFD]">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                        <div class="flex items-center space-x-4 mb-2 md:mb-0">
                            <div>
                                <h3 class="text-lg font-bold text-[#212529]">??n h?ng #ORD202508140001</h3>
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="text-right">
                                <div class="text-sm text-[#6C757D]">T?ng ti?n</div>
                    ...
                    <div id="details-ORD202508140001" class="hidden mt-6 pt-6 border-t border-gray-200">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            <!-- Delivery Info -->
                            <div>
                                <h4 class="font-bold text-[#212529] mb-3">? Th?ng tin giao h?ng</h4>
                                <div class="space-y-2 text-sm">
                                    <div class="flex justify-between">
                                        <span class="text-[#6C757D]">Ng??i nh?n:</span>
                                        <span class="text-[#212529]">Ho?ng ?inh</span>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="text-[#212529] text-right">123 ???ng Nguy?n V?n C?,<br>Ph??ng 4, Qu?n 5, TP.HCM</span>
                                    </div>
                                    <div class="flex justify-between">
                            ...
                            <!-- Order Timeline -->
                            <div>
                                <h4 class="font-bold text-[#212529] mb-3">? L?ch s? ??n h?ng</h4>
                                <div class="space-y-3">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-3 h-3 bg-[#198754] rounded-full"></div>
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-[#212529]">?? giao h?ng th?nh c?ng</div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-[#212529]">?ang giao h?ng</div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-[#212529]">?? x?c nh?n ??n h?ng</div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-1">
                                            <div class="text-sm font-medium text-[#212529]">??t h?ng th?nh c?ng</div>
            ...
            <div class="order-item bg-white rounded-lg shadow-sm border border-gray-200" data-status="shipping" data-order="ORD202508130002">
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                        <div class="flex items-center space-x-4 mb-2 md:mb-0">
                            <div>
                                <h3 class="text-lg font-bold text-[#212529]">??n h?ng #ORD202508130002</h3>
                                <div class="flex items-center space-x-4 text-sm text-[#6C757D]">
                    ...
                    <div class="mt-4 p-4 bg-[#E8F4FD] rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <div class="text-sm font-medium text-[#212529]">??n h?ng ?ang ???c giao ??n b?n</div>
                                <div class="text-xs text-[#6C757D]">D? ki?n giao: H?m nay, 16:00 - 18:00</div>
                                <div class="text-xs text-[#17A2B8] font-medium">M? v?n ??n: SPX123456789</div>
                            </div>
            ...
            <div class="order-item bg-white rounded-lg shadow-sm border border-gray-200" data-status="pending" data-order="ORD202508140003">
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                        <div class="flex items-center space-x-4 mb-2 md:mb-0">
                            <div>
                                <h3 class="text-lg font-bold text-[#212529]">??n h?ng #ORD202508140003</h3>
                                <div class="flex items-center space-x-4 text-sm text-[#6C757D]">
                    ...
                    <div class="mt-4 p-4 bg-[#FFF9E6] border border-[#FFC107] rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <div class="text-sm font-medium text-[#E67E22]">Ch? thanh to?n</div>
                                <div class="text-xs text-[#6C757D]">Vui l?ng ho?n t?t thanh to?n ?? x? l? ??n h?ng</div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="order-item bg-white rounded-lg shadow-sm border border-gray-200" data-status="cancelled" data-order="ORD202508110004">
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4">
                        <div class="flex items-center space-x-4 mb-2 md:mb-0">
                            <div>
                                <h3 class="text-lg font-bold text-[#212529]">??n h?ng #ORD202508110004</h3>
                                <div class="flex items-center space-x-4 text-sm text-[#6C757D]">
                    ...
                    <div class="mt-4 p-4 bg-[#FDF2F2] border border-[#DC3545] rounded-lg">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                <div class="text-sm font-medium text-[#DC3545]">L? do h?y: Thay ??i ? ??nh mua h?ng</div>
                                <div class="text-xs text-[#6C757D] mt-1">?? ho?n ti?n: ?21,280,000 ? Ng?y h?y: 11/08/2025 18:30</div>
                            </div>
                        </div>
                    </div>
        ...
        <div id="emptyState" class="hidden text-center py-12">
            ...
            <h3 class="text-xl font-bold text-[#212529] mb-2">Kh?ng t?m th?y ??n h?ng</h3>
            <p class="text-[#6C757D] mb-6">B?n ch?a c? ??n h?ng n?o ho?c kh?ng c? k?t qu? ph? h?p</p>
    ...
    <script>
        ...
        function reorderItems(orderId) {
            ...
            alert(`?ang th?m s?n ph?m t? ??n h?ng ${orderId} v?o gi? h?ng...`);
            // Redirect to cart or show success message
        }

        function downloadInvoice(orderId) {
            console.log('Downloading invoice for order:', orderId);
            alert(`?ang t?i h?a ??n cho ??n h?ng ${orderId}...`);
            // Trigger download
        }

        function writeReview(orderId) {
            console.log('Writing review for order:', orderId);
            alert(`Chuy?n ??n trang ??nh gi? cho ??n h?ng ${orderId}...`);
            // Redirect to review page
        }

        function trackOrder(orderId) {
            console.log('Tracking order:', orderId);
            alert(`Hi?n th? th?ng tin theo d?i cho ??n h?ng ${orderId}...`);
            // Show tracking modal or redirect
        }

        function contactShipper(orderId) {
            console.log('Contacting shipper for order:', orderId);
            alert(`Li?n h? v?i shipper cho ??n h?ng ${orderId}...`);
        }

        function payNow(orderId) {
            console.log('Processing payment for order:', orderId);
            alert(`Chuy?n ??n trang thanh to?n cho ??n h?ng ${orderId}...`);
        ...
        function cancelOrder(orderId) {
            if (confirm('B?n c? ch?c ch?n mu?n h?y ??n h?ng n?y?')) {
                ...
                alert(`?ang x? l? h?y ??n h?ng ${orderId}...`);
        ...
        function requestSupport(orderId) {
            ...
            alert(`M? ticket h? tr? cho ??n h?ng ${orderId}...`);
        }

        function loadMoreOrders() {
            const loadMoreBtn = document.getElementById('loadMoreBtn');
            loadMoreBtn.textContent = '?ang t?i...';
            loadMoreBtn.disabled = true;
            
            setTimeout(() => {
                loadMoreBtn.textContent = 'Kh?ng c?n ??n h?ng n?o';
                loadMoreBtn.disabled = true;
